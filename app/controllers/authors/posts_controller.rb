module Authors
  ...
  def create
    ...
    respond_to do |format|
      if @post.save
        format.html { redirect_to authors_post_path(@post), notice: 'Статья успешно создана.' }
  ...
  def update
    respond_to do |format|
      if @post.update(post_params)
        format.html { redirect_to authors_post_path(@post), notice: 'Статья успешно изменена.' }
  ...
  def destroy
    @post.destroy
    respond_to do |format|
      format.html { redirect_to authors_posts_url, notice: 'Статья успешно удалена.' }
